...
//   private readonly graph: Subgraph<false>;
//   private readonly resolveMap: ResolveMap;
//
//   constructor(graph: Subgraph<false>) {
//     this.graph = graph;
...
//  * exploration is needed.
//  */
// export class TraversalContextTemporal {
//   private readonly graph: Subgraph<true>;
//   private readonly resolveMap: ResolveMap;
//
//   constructor(graph: Subgraph<true>) {
//     this.graph = graph;
//     this.resolveMap = new ResolveMap({});
//   }
//
